...
K8S_SRV_PREFIX="$K8S_SRV_PREFIX/OU=Etcd Database Certificate Authority"

# --- Generate Etcd CA --- #
echo "Etcd CA"
KEY_PREFIX=ca
KEY_STORAGE=./Etcd
SUBJECT_K0S_CA="$K8S_SRV_PREFIX/CN=$KEY_PREFIX.etcd.$K8S_DOMAIN"

SUBJECT_FEATURE_01="nsComment=Askug Ltd. Kubernetes Etcd Certificate Authority"
